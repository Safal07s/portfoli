...
<?php
    ...
    ?>
        <div class=" container alert alert-success alert-dismissible fade show" role="alert">
            <strong>Reume-title is Deleted!</strong>
  ...
  <div class="pagetitle">
    <h1>Manage Resume-Titles</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
        <li class="breadcrumb-item">Resume-Titles</li>
        <li class="breadcrumb-item active">Manage Resume-Titles</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Manage Resume-Titles</h5>

            <!-- Table with stripped rows -->
            <a class="btn btn-primary btn-sm " href="create.php" role="button">Add Resume-Titles </a>
